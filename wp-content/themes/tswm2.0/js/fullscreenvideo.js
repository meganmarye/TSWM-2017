...
//    More info on //zerosixthree.se/create-a-responsive-header-video-with-graceful-degradation/
//  * -----------------------------------------------------------------------------
//  */
'use strict';
...
HeaderVideo.prototype.setFluidContainer = function() {
    ...
    $(window).resize(function() {
        ...
        element.height(Math.ceil(windowWidth * element.data('aspectRatio') - 20)); //Set the videos aspect ratio, see https://css-tricks.com/fluid-width-youtube-videos/
