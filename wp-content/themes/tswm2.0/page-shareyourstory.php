<?php /* Template Name: Share Your Story */  get_header(); ?>
				...
				<main role="main">
					<section>
						<div class="normal-content">
							...
							<?php wp_reset_query(); ?>
							<div>
								<dl class="accordion shareyourstoryform">
								<dt><a href="">Click here to share your story</a></dt>
								<dd>
							...
							<div class="testimonials-sys grid">
								<span>FEATURED TESTIMONIALS</span>
									...
									<?php
										...
										$testimonials_query = new WP_Query( $testimonials );

										if ( have_posts() ) : while ($testimonials_query->have_posts() ) : $testimonials_query->the_post();
									?>
									<!-- item -->
								...
								<div class="button-container"><a href="/testimonials/"><button class="btn btn-1 btn-1b">View All Testimonials</button></a></div>
							</div>
	...
	(function($) {
	  ...
	  $('.accordion > dt > a').click(function() {
		   if ($(this).hasClass('open')){
	        	...
	        	allPanels.slideUp();
	        	$(this).text('Click here to share your story');
	        	return false;
		    }
			else {
	        	$(this).addClass('open');
	        	$(this).parent().next().slideDown();
	        	$(this).text('Click here to hide form');
